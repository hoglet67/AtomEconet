...
.ca120
    lda l0230                                                         ; a120: ad 30 02    .0.
    sta l00b4                                                         ; a123: 85 b4       ..
    lda l0231                                                         ; a125: ad 31 02    .1.
...
.ca182
    ...
    inc l0102,x                                                       ; a18d: fe 02 01    ...
    bne ca16c                                                         ; a190: d0 da       ..
    inc l0103,x                                                       ; a192: fe 03 01    ...
...
.sub_ca494
    ...
    lda jump1_table_hi-&81,y                                          ; a49f: b9 32 a4    .2.
    pha                                                               ; a4a2: 48          H
    lda jump1_table_lo-&81,y                                          ; a4a3: b9 2a a4    .*.
    pha                                                               ; a4a6: 48          H
    rts                                                               ; a4a7: 60          `
...
.jump1_table_lo
    equb <(jump1_81_88-1)                                             ; a4ab: ba          .
    equb <(jump1_82-1)                                                ; a4ac: f6          .
    equb <(jump1_83_84_85-1)                                          ; a4ad: 18          .
    equb <(jump1_83_84_85-1)                                          ; a4ae: 18          .
    equb <(jump1_83_84_85-1)                                          ; a4af: 18          .
    equb <(jump1_86_87-1)                                             ; a4b0: 34          4
    equb <(jump1_86_87-1)                                             ; a4b1: 34          4
    equb <(jump1_81_88-1)                                             ; a4b2: ba          .
.jump1_table_hi
    equb >(jump1_81_88-1)                                             ; a4b3: a4          .
    equb >(jump1_82-1)                                                ; a4b4: a4          .
    equb >(jump1_83_84_85-1)                                          ; a4b5: a5          .
    equb >(jump1_83_84_85-1)                                          ; a4b6: a5          .
    equb >(jump1_83_84_85-1)                                          ; a4b7: a5          .
    equb >(jump1_86_87-1)                                             ; a4b8: a5          .
    equb >(jump1_86_87-1)                                             ; a4b9: a5          .
    equb >(jump1_81_88-1)                                             ; a4ba: a4          .
...
.ca562
    ...
    lda jump2_table_hi-&81,y                                          ; a564: b9 fa a4    ...
    pha                                                               ; a567: 48          H
    lda jump2_table_lo-&81,y                                          ; a568: b9 f2 a4    ...
    pha                                                               ; a56b: 48          H
    rts                                                               ; a56c: 60          `
...
.jump2_table_lo
    equb <(jump2_81-1)                                                ; a573: 93          .
    equb <(jump2_82-1)                                                ; a574: ac          .
    equb <(jump2_83-1)                                                ; a575: d5          .
    equb <(jump2_84-1)                                                ; a576: c0          .
    equb <(jump2_85-1)                                                ; a577: c9          .
    equb <(jump2_86-1)                                                ; a578: 13          .
    equb <(jump2_87-1)                                                ; a579: 2f          /
    equb <(jump2_88-1)                                                ; a57a: 82          .
.jump2_table_hi
    equb >(jump2_81-1)                                                ; a57b: a5          .
    equb >(jump2_82-1)                                                ; a57c: a5          .
    equb >(jump2_83-1)                                                ; a57d: a5          .
    equb >(jump2_84-1)                                                ; a57e: a5          .
    equb >(jump2_85-1)                                                ; a57f: a5          .
    equb >(jump2_86-1)                                                ; a580: a6          .
    equb >(jump2_87-1)                                                ; a581: a6          .
    equb >(jump2_88-1)                                                ; a582: a5          .
...
.jump2_84
    lda l0238                                                         ; a5c1: ad 38 02    .8.
    ldy l0239                                                         ; a5c4: ac 39 02    .9.
...
.jump2_83
    ...
    lda #&1c                                                          ; a5f4: a9 1c       ..
    ora l023b                                                         ; a5f6: 0d 3b 02    .;.
    sta l023b                                                         ; a5f9: 8d 3b 02    .;.
...
.jump2_86
    ...
    lda #&40                                                          ; a617: a9 40       .@
    bit l023a                                                         ; a619: 2c 3a 02    ,:.
    bne ca62f                                                         ; a61c: d0 11       ..
    ora l023a                                                         ; a61e: 0d 3a 02    .:.
    sta l023a                                                         ; a621: 8d 3a 02    .:.
    jsr sub_ca095                                                     ; a624: 20 95 a0     ..
    cli                                                               ; a627: 58          X
    lda #&40                                                          ; a628: a9 40       .@
.loop_ca62a
    bit l023a                                                         ; a62a: 2c 3a 02    ,:.
...
.jump2_87
    ...
    lda #&bf                                                          ; a633: a9 bf       ..
    and l023a                                                         ; a635: 2d 3a 02    -:.
    sta l023a                                                         ; a638: 8d 3a 02    .:.
    rts                                                               ; a63b: 60          `
...
.sub_ca65b
    jsr sub_ca6bc                                                     ; a65b: 20 bc a6     ..
.sub_ca65e
    jsr sub_ca66d                                                     ; a65e: 20 6d a6     m.
    lda l011a                                                         ; a661: ad 1a 01    ...
    beq ca669                                                         ; a664: f0 03       ..
    jmp ca83c                                                         ; a666: 4c 3c a8    L<.

.ca669
    lda l0119                                                         ; a669: ad 19 01    ...
    rts                                                               ; a66c: 60          `
...
.ca67a
    ...
    lda #2                                                            ; a68b: a9 02       ..
    jmp ca83c                                                         ; a68d: 4c 3c a8    L<.

.ca690
    pha                                                               ; a690: 48          H
    lda l023a                                                         ; a691: ad 3a 02    .:.
    and #&7f                                                          ; a694: 29 7f       ).
    sta l023a                                                         ; a696: 8d 3a 02    .:.
    pla                                                               ; a699: 68          h
    rts                                                               ; a69a: 60          `
...
.loop_ca69d
    ...
    sta l00d0,x                                                       ; a6a0: 95 d0       ..
    dex                                                               ; a6a2: ca          .
    bpl loop_ca69d                                                    ; a6a3: 10 f8       ..
    jsr sub_ca80d                                                     ; a6a5: 20 0d a8     ..
    jmp ca85d                                                         ; a6a8: 4c 5d a8    L].
...
.loop_ca6be
    ...
    stx l00d0,y                                                       ; a6c1: 96 d0       ..
    dey                                                               ; a6c3: 88          .
    bpl loop_ca6be                                                    ; a6c4: 10 f8       ..
    jsr sub_ca80d                                                     ; a6c6: 20 0d a8     ..
    lda #&60                                                          ; a6c9: a9 60       .`
    ldy #&30                                                          ; a6cb: a0 30       .0
    jmp ca818                                                         ; a6cd: 4c 18 a8    L..

.handler1
    jsr sub_caff1                                                     ; a6d0: 20 f1 af     ..
    lsr l00fe                                                         ; a6d3: 46 fe       F.
    jmp ca83c                                                         ; a6d5: 4c 3c a8    L<.
...
.init_0228_022f
    equb         0,         0, <handler2, >handler2,       &fe        ; a6e4: 00 00 f9... ...
    equb         0,       &eb,         0                              ; a6e9: 00 eb 00    ...
.init_00d4_00d9
...
.function3
    jmp ca658                                                         ; a709: 4c 58 a6    LX.

.function4
    jmp function7                                                     ; a70c: 4c 16 a7    L..

.function5
    jmp ca81a                                                         ; a70f: 4c 1a a8    L..
...
.function7
    pha                                                               ; a716: 48          H
    lda l023b                                                         ; a717: ad 3b 02    .;.
    and #&e3                                                          ; a71a: 29 e3       ).
    sta l023b                                                         ; a71c: 8d 3b 02    .;.
    pla                                                               ; a71f: 68          h
    cmp #1                                                            ; a720: c9 01       ..
    bne ca72b                                                         ; a722: d0 07       ..
    stx l0228                                                         ; a724: 8e 28 02    .(.
    sty l0229                                                         ; a727: 8c 29 02    .).
.loop_ca72a
    rts                                                               ; a72a: 60          `
...
.cmd_UNKNOWN
    ldy #0                                                            ; a79f: a0 00       ..
.loop_ca7a1
    lda l0100,y                                                       ; a7a1: b9 00 01    ...
    iny                                                               ; a7a4: c8          .
    cmp #&0d                                                          ; a7a5: c9 0d       ..
    bne loop_ca7a1                                                    ; a7a7: d0 f8       ..
.loop_ca7a9
    lda l0100,y                                                       ; a7a9: b9 00 01    ...
    sta l011b,y                                                       ; a7ac: 99 1b 01    ...
    dey                                                               ; a7af: 88          .
    bpl loop_ca7a9                                                    ; a7b0: 10 f7       ..
    iny                                                               ; a7b2: c8          .
    jsr ca658                                                         ; a7b3: 20 58 a6     X.
    beq ca7c3                                                         ; a7b6: f0 0b       ..
    asl a                                                             ; a7b8: 0a          .
    tax                                                               ; a7b9: aa          .
    lda jump3_table - 1,x                                             ; a7ba: bd cf a7    ...
    pha                                                               ; a7bd: 48          H
    lda jump3_table - 2,x                                             ; a7be: bd ce a7    ...
    pha                                                               ; a7c1: 48          H
    rts                                                               ; a7c2: 60          `
...
.jump3_table
    equw jump3_00-1                                                   ; a7d0: 9e a9       ..
    equw jump3_01-1                                                   ; a7d2: 71 aa       q.
    equw jump3_02-1                                                   ; a7d4: 11 ac       ..
    equw jump3_03-1                                                   ; a7d6: 89 ac       ..
    equw jump3_04_05-1                                                ; a7d8: 39 a9       9.
    equw jump3_04_05-1                                                ; a7da: 39 a9       9.
    equw jump3_06-1                                                   ; a7dc: be ac       ..
    equw jump3_07-1                                                   ; a7de: b1 ac       ..
    equw jump3_08-1                                                   ; a7e0: c5 ac       ..
...
.sub_ca7f7
    ldx #&88                                                          ; a7f7: a2 88       ..
    stx l0116                                                         ; a7f9: 8e 16 01    ...
    sty l0117                                                         ; a7fc: 8c 17 01    ...
    pha                                                               ; a7ff: 48          H
    ldx #2                                                            ; a800: a2 02       ..
.loop_ca802
    lda l0224,x                                                       ; a802: bd 24 02    .$.
    sta l0118,x                                                       ; a805: 9d 18 01    ...
    dex                                                               ; a808: ca          .
...
.sub_ca80d
    lda l022c                                                         ; a80d: ad 2c 02    .,.
    sta l00d2                                                         ; a810: 85 d2       ..
    lda l022d                                                         ; a812: ad 2d 02    .-.
    sta l00d3                                                         ; a815: 85 d3       ..
    rts                                                               ; a817: 60          `
...
.ca81a
    ...
    jsr sub_ca848                                                     ; a835: 20 48 a8     H.
    bne ca81a                                                         ; a838: d0 e0       ..
.ca83a
    lda #1                                                            ; a83a: a9 01       ..
.ca83c
    ldx #&19                                                          ; a83c: a2 19       ..
    ldy #1                                                            ; a83e: a0 01       ..
    jmp (l022a)                                                       ; a840: 6c 2a 02    l*.
...
.ca85d
    ...
    ldx #0                                                            ; a85f: a2 00       ..
.sub_ca861
    jsr ca690                                                         ; a861: 20 90 a6     ..
    sta l0230                                                         ; a864: 8d 30 02    .0.
    stx l0231                                                         ; a867: 8e 31 02    .1.
    lda l023a                                                         ; a86a: ad 3a 02    .:.
    ora #&80                                                          ; a86d: 09 80       ..
    sta l023a                                                         ; a86f: 8d 3a 02    .:.
    rts                                                               ; a872: 60          `
...
.sub_ca873
    ...
    lda l0100,y                                                       ; a87c: b9 00 01    ...
    cmp #&3a                                                          ; a87f: c9 3a       .:
    bcs ca8bd                                                         ; a881: b0 3a       .:
    sbc #&2f                                                          ; a883: e9 2f       ./
    bmi ca8bd                                                         ; a885: 30 36       06
.ca887
    lda l0100,y                                                       ; a887: b9 00 01    ...
    cmp #&3a                                                          ; a88a: c9 3a       .:
...
.ca8bd
    ...
    ldx #0                                                            ; a8bf: a2 00       ..
.loop_ca8c1
    lda l0100,y                                                       ; a8c1: b9 00 01    ...
    cmp #&20                                                          ; a8c4: c9 20       .
    beq ca8d3                                                         ; a8c6: f0 0b       ..
    cmp #&0d                                                          ; a8c8: c9 0d       ..
    beq ca8d3                                                         ; a8ca: f0 07       ..
    sta l011b,x                                                       ; a8cc: 9d 1b 01    ...
    inx                                                               ; a8cf: e8          .
    iny                                                               ; a8d0: c8          .
    bne loop_ca8c1                                                    ; a8d1: d0 ee       ..
.ca8d3
    lda #&0d                                                          ; a8d3: a9 0d       ..
    sta l011b,x                                                       ; a8d5: 9d 1b 01    ...
    tya                                                               ; a8d8: 98          .
    pha                                                               ; a8d9: 48          H
    ldy #&18                                                          ; a8da: a0 18       ..
    jsr ca658                                                         ; a8dc: 20 58 a6     X.
    pla                                                               ; a8df: 68          h
    tay                                                               ; a8e0: a8          .
    pla                                                               ; a8e1: 68          h
    tax                                                               ; a8e2: aa          .
    lda l011c                                                         ; a8e3: ad 1c 01    ...
    sta l0000,x                                                       ; a8e6: 95 00       ..
    lda l011d                                                         ; a8e8: ad 1d 01    ...
...
.ca922
    ...
    ldy #2                                                            ; a924: a0 02       ..
.loop_ca926
    stx l00d0                                                         ; a926: 86 d0       ..
    pla                                                               ; a928: 68          h
    pha                                                               ; a929: 48          H
    sta l00d1                                                         ; a92a: 85 d1       ..
    lda (l00d0),y                                                     ; a92c: b1 d0       ..
    jsr osasci                                                        ; a92e: 20 e9 ff     ..
    iny                                                               ; a931: c8          .
    cmp #&0d                                                          ; a932: c9 0d       ..
    bne loop_ca926                                                    ; a934: d0 f0       ..
.ca936
    jsr ca690                                                         ; a936: 20 90 a6     ..
    brk                                                               ; a939: 00          .

.jump3_04_05
    ldx #2                                                            ; a93a: a2 02       ..
.loop_ca93c
    lda l011b,x                                                       ; a93c: bd 1b 01    ...
    sta l0224,x                                                       ; a93f: 9d 24 02    .$.
    dex                                                               ; a942: ca          .
    bpl loop_ca93c                                                    ; a943: 10 f7       ..
    jmp ca7c3                                                         ; a945: 4c c3 a7    L..
...
.sub_ca948
    ...
    sty l00d1                                                         ; a955: 84 d1       ..
    jsr sub_ca80d                                                     ; a957: 20 0d a8     ..
    lda #&12                                                          ; a95a: a9 12       ..
    sta l00d4                                                         ; a95c: 85 d4       ..
    lda #1                                                            ; a95e: a9 01       ..
    sta l00d5                                                         ; a960: 85 d5       ..
    lda l0227                                                         ; a962: ad 27 02    .'.
    ldx #8                                                            ; a965: a2 08       ..
.loop_ca967
...
.sub_ca973
    ora #&80                                                          ; a973: 09 80       ..
    sta l00d0                                                         ; a975: 85 d0       ..
    clc                                                               ; a977: 18          .
    txa                                                               ; a978: 8a          .
    adc l00d4                                                         ; a979: 65 d4       e.
    sta l00d6                                                         ; a97b: 85 d6       ..
    lda l00d5                                                         ; a97d: a5 d5       ..
    adc #0                                                            ; a97f: 69 00       i.
    sta l00d7                                                         ; a981: 85 d7       ..
    lda #&ff                                                          ; a983: a9 ff       ..
    jsr ca818                                                         ; a985: 20 18 a8     ..
    ldx #&7f                                                          ; a988: a2 7f       ..
    stx l00d0                                                         ; a98a: 86 d0       ..
    ldx #&ff                                                          ; a98c: a2 ff       ..
    stx l00d6                                                         ; a98e: 86 d6       ..
    stx l00d7                                                         ; a990: 86 d7       ..
    inx                                                               ; a992: e8          .
    stx l00d8                                                         ; a993: 86 d8       ..
    jsr ca85d                                                         ; a995: 20 5d a8     ].
    jsr sub_ca670                                                     ; a998: 20 70 a6     p.
    lda l0112                                                         ; a99b: ad 12 01    ...
    rts                                                               ; a99e: 60          `

.jump3_00
    clc                                                               ; a99f: 18          .
    lda l011b                                                         ; a9a0: ad 1b 01    ...
    sta l013c                                                         ; a9a3: 8d 3c 01    .<.
    adc l0123                                                         ; a9a6: 6d 23 01    m#.
    sta l013e                                                         ; a9a9: 8d 3e 01    .>.
    lda l011c                                                         ; a9ac: ad 1c 01    ...
...
.eco_save
    ...
    lda #0                                                            ; a9e3: a9 00       ..
.loop_ca9e5
    sta l011b,y                                                       ; a9e5: 99 1b 01    ...
    dey                                                               ; a9e8: 88          .
    bpl loop_ca9e5                                                    ; a9e9: 10 fa       ..
    iny                                                               ; a9eb: c8          .
.loop_ca9ec
    lda l0002,x                                                       ; a9ec: b5 02       ..
    sta l011b,y                                                       ; a9ee: 99 1b 01    ...
    lda l0003,x                                                       ; a9f1: b5 03       ..
    sta l011c,y                                                       ; a9f3: 99 1c 01    ...
    iny                                                               ; a9f6: c8          .
    iny                                                               ; a9f7: c8          .
    iny                                                               ; a9f8: c8          .
    iny                                                               ; a9f9: c8          .
...
.caa00
    ldy #1                                                            ; aa00: a0 01       ..
    jsr sub_ca7f7                                                     ; aa02: 20 f7 a7     ..
    lda #&77                                                          ; aa05: a9 77       .w
    sta l0118                                                         ; aa07: 8d 18 01    ...
    jsr sub_ca65b                                                     ; aa0a: 20 5b a6     [.
    lda #0                                                            ; aa0d: a9 00       ..
    sta l0120                                                         ; aa0f: 8d 20 01    . .
.caa12
    lda l013c                                                         ; aa12: ad 3c 01    .<.
    sta l00d4                                                         ; aa15: 85 d4       ..
    clc                                                               ; aa17: 18          .
    adc l011c                                                         ; aa18: 6d 1c 01    m..
    sta l00d6                                                         ; aa1b: 85 d6       ..
    lda l013d                                                         ; aa1d: ad 3d 01    .=.
    sta l00d5                                                         ; aa20: 85 d5       ..
    adc l011d                                                         ; aa22: 6d 1d 01    m..
    sta l00d7                                                         ; aa25: 85 d7       ..
    bcs caa35                                                         ; aa27: b0 0c       ..
    lda l00d6                                                         ; aa29: a5 d6       ..
    cmp l013e                                                         ; aa2b: cd 3e 01    .>.
    lda l00d7                                                         ; aa2e: a5 d7       ..
    sbc l013f                                                         ; aa30: ed 3f 01    .?.
    bcc caa42                                                         ; aa33: 90 0d       ..
.caa35
    lda l013e                                                         ; aa35: ad 3e 01    .>.
    sta l00d6                                                         ; aa38: 85 d6       ..
    lda l013f                                                         ; aa3a: ad 3f 01    .?.
    sta l00d7                                                         ; aa3d: 85 d7       ..
    inc l0120                                                         ; aa3f: ee 20 01    . .
.caa42
    lda l011b                                                         ; aa42: ad 1b 01    ...
    sta l00d1                                                         ; aa45: 85 d1       ..
    ldx #&d0                                                          ; aa47: a2 d0       ..
    ldy #&0a                                                          ; aa49: a0 0a       ..
    lda #&ff                                                          ; aa4b: a9 ff       ..
    jsr ca81a                                                         ; aa4d: 20 1a a8     ..
    lda l0120                                                         ; aa50: ad 20 01    . .
    bne caa6c                                                         ; aa53: d0 17       ..
    lda l00d6                                                         ; aa55: a5 d6       ..
    sta l013c                                                         ; aa57: 8d 3c 01    .<.
    lda l00d7                                                         ; aa5a: a5 d7       ..
    sta l013d                                                         ; aa5c: 8d 3d 01    .=.
    jsr sub_ca69b                                                     ; aa5f: 20 9b a6     ..
    lda #&77                                                          ; aa62: a9 77       .w
    sta l00d1                                                         ; aa64: 85 d1       ..
    jsr sub_ca670                                                     ; aa66: 20 70 a6     p.
    jmp caa12                                                         ; aa69: 4c 12 aa    L..

.caa6c
    jsr sub_ca65e                                                     ; aa6c: 20 5e a6     ^.
    jmp ca7c3                                                         ; aa6f: 4c c3 a7    L..

.jump3_01
    lda l011b                                                         ; aa72: ad 1b 01    ...
    sta l013d                                                         ; aa75: 8d 3d 01    .=.
    lda l011c                                                         ; aa78: ad 1c 01    ...
    sta l013e                                                         ; aa7b: 8d 3e 01    .>.
    lda l011f                                                         ; aa7e: ad 1f 01    ...
    sta l013f                                                         ; aa81: 8d 3f 01    .?.
    ldx #0                                                            ; aa84: a2 00       ..
.loop_caa86
    lda l0120,x                                                       ; aa86: bd 20 01    . .
    sta l011b,x                                                       ; aa89: 9d 1b 01    ...
    inx                                                               ; aa8c: e8          .
    cmp #&0d                                                          ; aa8d: c9 0d       ..
...
.caaa7
    ldy #2                                                            ; aaa7: a0 02       ..
.sub_caaa9
    jsr sub_ca7f7                                                     ; aaa9: 20 f7 a7     ..
    ldx #&2d                                                          ; aaac: a2 2d       .-
    stx l0118                                                         ; aaae: 8e 18 01    ...
    jsr sub_ca65b                                                     ; aab1: 20 5b a6     [.
    bit l013f                                                         ; aab4: 2c 3f 01    ,?.
    bpl caac6                                                         ; aab7: 10 0d       ..
    lda l013d                                                         ; aab9: ad 3d 01    .=.
    sta l00d4                                                         ; aabc: 85 d4       ..
    lda l013e                                                         ; aabe: ad 3e 01    .>.
    sta l00d5                                                         ; aac1: 85 d5       ..
    jmp caad2                                                         ; aac3: 4c d2 aa    L..

.caac6
    lda l011b                                                         ; aac6: ad 1b 01    ...
    sta l00d4                                                         ; aac9: 85 d4       ..
    lda l011c                                                         ; aacb: ad 1c 01    ...
    sta l00d5                                                         ; aace: 85 d5       ..
    lda #8                                                            ; aad0: a9 08       ..
.caad2
    pha                                                               ; aad2: 48          H
    clc                                                               ; aad3: 18          .
    lda l00d4                                                         ; aad4: a5 d4       ..
    adc l0123                                                         ; aad6: 6d 23 01    m#.
    sta l0123                                                         ; aad9: 8d 23 01    .#.
    lda l00d5                                                         ; aadc: a5 d5       ..
    adc l0124                                                         ; aade: 6d 24 01    m$.
    sta l0124                                                         ; aae1: 8d 24 01    .$.
    lda #&2d                                                          ; aae4: a9 2d       .-
    sta l00d1                                                         ; aae6: 85 d1       ..
.caae8
    lda #&ff                                                          ; aae8: a9 ff       ..
    sta l00d6                                                         ; aaea: 85 d6       ..
    sta l00d7                                                         ; aaec: 85 d7       ..
    lda #&7f                                                          ; aaee: a9 7f       ..
    sta l00d0                                                         ; aaf0: 85 d0       ..
    jsr ca85d                                                         ; aaf2: 20 5d a8     ].
    ldy #&d0                                                          ; aaf5: a0 d0       ..
    pla                                                               ; aaf7: 68          h
    jsr sub_ca674                                                     ; aaf8: 20 74 a6     t.
    lda l00d6                                                         ; aafb: a5 d6       ..
    cmp l0123                                                         ; aafd: cd 23 01    .#.
    lda l00d7                                                         ; ab00: a5 d7       ..
    sbc l0124                                                         ; ab02: ed 24 01    .$.
    bcs cab15                                                         ; ab05: b0 0e       ..
    lda l00d6                                                         ; ab07: a5 d6       ..
    sta l00d4                                                         ; ab09: 85 d4       ..
    lda l00d7                                                         ; ab0b: a5 d7       ..
    sta l00d5                                                         ; ab0d: 85 d5       ..
    lda #8                                                            ; ab0f: a9 08       ..
    pha                                                               ; ab11: 48          H
...
.cab15
    ...
    lda l011f                                                         ; ab18: ad 1f 01    ...
    sta l00d0                                                         ; ab1b: 85 d0       ..
    lda l0120                                                         ; ab1d: ad 20 01    . .
    sta l00d1                                                         ; ab20: 85 d1       ..
    jmp ca7c3                                                         ; ab22: 4c c3 a7    L..

.eco_find
    lda #0                                                            ; ab25: a9 00       ..
    sta l011c                                                         ; ab27: 8d 1c 01    ...
    rol a                                                             ; ab2a: 2a          *
    sta l011b                                                         ; ab2b: 8d 1b 01    ...
    lda #7                                                            ; ab2e: a9 07       ..
    jsr sub_ca7e4                                                     ; ab30: 20 e4 a7     ..
    ldy #6                                                            ; ab33: a0 06       ..
    jsr sub_ca7f7                                                     ; ab35: 20 f7 a7     ..
    jsr sub_ca6bc                                                     ; ab38: 20 bc a6     ..
    jsr sub_ca66d                                                     ; ab3b: 20 6d a6     m.
    lda l011a                                                         ; ab3e: ad 1a 01    ...
    beq cab4e                                                         ; ab41: f0 0b       ..
    cmp #&43                                                          ; ab43: c9 43       .C
    beq cab4a                                                         ; ab45: f0 03       ..
    jmp ca83c                                                         ; ab47: 4c 3c a8    L<.
...
.cab4e
    clc                                                               ; ab4e: 18          .
    sbc l011b                                                         ; ab4f: ed 1b 01    ...
    and l0227                                                         ; ab52: 2d 27 02    -'.
    sta l0227                                                         ; ab55: 8d 27 02    .'.
    lda l011b                                                         ; ab58: ad 1b 01    ...
.cab5b
    jmp ca7c3                                                         ; ab5b: 4c c3 a7    L..
...
.cab95
    pla                                                               ; ab95: 68          h
    tay                                                               ; ab96: a8          .
    eor l0227                                                         ; ab97: 4d 27 02    M'.
    sta l0227                                                         ; ab9a: 8d 27 02    .'.
    pla                                                               ; ab9d: 68          h
    tax                                                               ; ab9e: aa          .
...
.eco_star
    txa                                                               ; aba3: 8a          .
    pha                                                               ; aba4: 48          H
    sty l011b                                                         ; aba5: 8c 1b 01    ...
    ldy #0                                                            ; aba8: a0 00       ..
    sty l011c                                                         ; abaa: 8c 1c 01    ...
.loop_cabad
    lda l0000,x                                                       ; abad: b5 00       ..
    sta l011d,y                                                       ; abaf: 99 1d 01    ...
    inx                                                               ; abb2: e8          .
    iny                                                               ; abb3: c8          .
    cpy #3                                                            ; abb4: c0 03       ..
    bne loop_cabad                                                    ; abb6: d0 f5       ..
    ldy #&0d                                                          ; abb8: a0 0d       ..
    jsr ca658                                                         ; abba: 20 58 a6     X.
    pla                                                               ; abbd: 68          h
    tax                                                               ; abbe: aa          .
    ldy l011b                                                         ; abbf: ac 1b 01    ...
    rts                                                               ; abc2: 60          `

.eco_rdar
    sty l011b                                                         ; abc3: 8c 1b 01    ...
    sta l011c                                                         ; abc6: 8d 1c 01    ...
    tya                                                               ; abc9: 98          .
    pha                                                               ; abca: 48          H
    txa                                                               ; abcb: 8a          .
    pha                                                               ; abcc: 48          H
    ldy #&0c                                                          ; abcd: a0 0c       ..
    jsr ca658                                                         ; abcf: 20 58 a6     X.
    pla                                                               ; abd2: 68          h
    tax                                                               ; abd3: aa          .
    inx                                                               ; abd4: e8          .
    inx                                                               ; abd5: e8          .
...
.eco_shut
    tya                                                               ; abe5: 98          .
    pha                                                               ; abe6: 48          H
    sta l011b                                                         ; abe7: 8d 1b 01    ...
    ldy #7                                                            ; abea: a0 07       ..
    jsr ca658                                                         ; abec: 20 58 a6     X.
    pla                                                               ; abef: 68          h
    tay                                                               ; abf0: a8          .
    rts                                                               ; abf1: 60          `
...
.cmd_I_AM
    ...
    lda l0100,y                                                       ; abf5: b9 00 01    ...
    cmp #&30                                                          ; abf8: c9 30       .0
    bcc cac0f                                                         ; abfa: 90 13       ..
    cmp #&3a                                                          ; abfc: c9 3a       .:
    bcs cac0f                                                         ; abfe: b0 0f       ..
    ldx #&d0                                                          ; ac00: a2 d0       ..
    jsr sub_ca873                                                     ; ac02: 20 73 a8     s.
    lda l00d0                                                         ; ac05: a5 d0       ..
    sta l022c                                                         ; ac07: 8d 2c 02    .,.
    lda l00d1                                                         ; ac0a: a5 d1       ..
    sta l022d                                                         ; ac0c: 8d 2d 02    .-.
.cac0f
...
.jump3_02
    ldy #0                                                            ; ac12: a0 00       ..
.loop_cac14
    lda l011b,y                                                       ; ac14: b9 1b 01    ...
    sta l0148,y                                                       ; ac17: 99 48 01    .H.
    iny                                                               ; ac1a: c8          .
    cmp #&0d                                                          ; ac1b: c9 0d       ..
    bne loop_cac14                                                    ; ac1d: d0 f5       ..
    ldy #4                                                            ; ac1f: a0 04       ..
    jsr ca658                                                         ; ac21: 20 58 a6     X.
    jsr sub_caca4                                                     ; ac24: 20 a4 ac     ..
    jsr oscrlf                                                        ; ac27: 20 ed ff     ..
    lda #0                                                            ; ac2a: a9 00       ..
.cac2c
    pha                                                               ; ac2c: 48          H
    sta l011c                                                         ; ac2d: 8d 1c 01    ...
    lda #3                                                            ; ac30: a9 03       ..
    sta l011b                                                         ; ac32: 8d 1b 01    ...
    lda #2                                                            ; ac35: a9 02       ..
    sta l011d                                                         ; ac37: 8d 1d 01    ...
    lda #&48                                                          ; ac3a: a9 48       .H
    sta l00d0                                                         ; ac3c: 85 d0       ..
    lda #1                                                            ; ac3e: a9 01       ..
    sta l00d1                                                         ; ac40: 85 d1       ..
    ldx #&d0                                                          ; ac42: a2 d0       ..
    lda #8                                                            ; ac44: a9 08       ..
    jsr sub_ca7e4                                                     ; ac46: 20 e4 a7     ..
    ldy #3                                                            ; ac49: a0 03       ..
    jsr sub_ca7f7                                                     ; ac4b: 20 f7 a7     ..
    jsr sub_ca6bc                                                     ; ac4e: 20 bc a6     ..
    ldx #8                                                            ; ac51: a2 08       ..
.loop_cac53
    lda init_00d0_00d8_alt1,x                                         ; ac53: bd 81 ac    ...
    sta l00d0,x                                                       ; ac56: 95 d0       ..
    dex                                                               ; ac58: ca          .
    bpl loop_cac53                                                    ; ac59: 10 f8       ..
    jsr sub_ca80d                                                     ; ac5b: 20 0d a8     ..
    jsr ca85d                                                         ; ac5e: 20 5d a8     ].
    jsr sub_ca670                                                     ; ac61: 20 70 a6     p.
    lda l0117                                                         ; ac64: ad 17 01    ...
    beq cac70                                                         ; ac67: f0 07       ..
    ldx #&16                                                          ; ac69: a2 16       ..
    ldy #1                                                            ; ac6b: a0 01       ..
    jmp (l022a)                                                       ; ac6d: 6c 2a 02    l*.

.cac70
    lda l0118                                                         ; ac70: ad 18 01    ...
    beq cac7f                                                         ; ac73: f0 0a       ..
    jsr sub_ca788                                                     ; ac75: 20 88 a7     ..
    pla                                                               ; ac78: 68          h
    clc                                                               ; ac79: 18          .
    adc #2                                                            ; ac7a: 69 02       i.
...
.jump3_07
    ...
    jmp (l00d0)                                                       ; acbc: 6c d0 00    l..

.jump3_06
    lda l011b                                                         ; acbf: ad 1b 01    ...
    sta l0225                                                         ; acc2: 8d 25 02    .%.
    rts                                                               ; acc5: 60          `

.jump3_08
    lda l011b                                                         ; acc6: ad 1b 01    ...
    sta l0226                                                         ; acc9: 8d 26 02    .&.
    rts                                                               ; accc: 60          `
...
.sub_cad2a
    stx l00ef                                                         ; ad2a: 86 ef       ..
    sty l00f0                                                         ; ad2c: 84 f0       ..
    ldx #4                                                            ; ad2e: a2 04       ..
.loop_cad30
    lda init_00f1_00f5,x                                              ; ad30: bd 39 ad    .9.
    sta l00f1,x                                                       ; ad33: 95 f1       ..
    dex                                                               ; ad35: ca          .
...
.sub_cad3e
    lda #<handler3                                                    ; ad3e: a9 62       .b
    sta l022a                                                         ; ad40: 8d 2a 02    .*.
    lda #>handler3                                                    ; ad43: a9 ad       ..
    sta l022b                                                         ; ad45: 8d 2b 02    .+.
    lda #&80                                                          ; ad48: a9 80       ..
    sta l00ed                                                         ; ad4a: 85 ed       ..
    lda #&ff                                                          ; ad4c: a9 ff       ..
    ldy #&14                                                          ; ad4e: a0 14       ..
    ldx #&ed                                                          ; ad50: a2 ed       ..
    jsr ca81a                                                         ; ad52: 20 1a a8     ..
.sub_cad55
    pha                                                               ; ad55: 48          H
    lda #<handler2                                                    ; ad56: a9 f9       ..
    sta l022a                                                         ; ad58: 8d 2a 02    .*.
    lda #>handler2                                                    ; ad5b: a9 a8       ..
    sta l022b                                                         ; ad5d: 8d 2b 02    .+.
    pla                                                               ; ad60: 68          h
    rts                                                               ; ad61: 60          `
...
.cad6b
    jsr sub_cad2a                                                     ; ad6b: 20 2a ad     *.
    ldx #3                                                            ; ad6e: a2 03       ..
.loop_cad70
    lda vectors2,x                                                    ; ad70: bd 80 ad    ...
...
.vectors2
    equw eco_wrch2, eco_rdch2                                         ; ad80: c2 ad 9e... ...
...
.cmd_ROFF
    ...
    lda #&c0                                                          ; ad8b: a9 c0       ..
    sta l00ee                                                         ; ad8d: 85 ee       ..
    jsr sub_cad3e                                                     ; ad8f: 20 3e ad     >.
    jsr sub_ca6d8                                                     ; ad92: 20 d8 a6     ..
    jsr ca690                                                         ; ad95: 20 90 a6     ..
    lda #0                                                            ; ad98: a9 00       ..
...
.eco_rdch2
    ...
    pha                                                               ; ada1: 48          H
    lda #&c1                                                          ; ada2: a9 c1       ..
    sta l00ee                                                         ; ada4: 85 ee       ..
    jsr sub_cad3e                                                     ; ada6: 20 3e ad     >.
    lda #&7f                                                          ; ada9: a9 7f       ..
    sta l00ed                                                         ; adab: 85 ed       ..
    lda #&ed                                                          ; adad: a9 ed       ..
    ldx #0                                                            ; adaf: a2 00       ..
    jsr sub_ca861                                                     ; adb1: 20 61 a8     a.
.loop_cadb4
    lda l00ed                                                         ; adb4: a5 ed       ..
    bpl loop_cadb4                                                    ; adb6: 10 fc       ..
    jsr ca690                                                         ; adb8: 20 90 a6     ..
    pla                                                               ; adbb: 68          h
    tay                                                               ; adbc: a8          .
    pla                                                               ; adbd: 68          h
    tax                                                               ; adbe: aa          .
    lda l00f6                                                         ; adbf: a5 f6       ..
    rts                                                               ; adc1: 60          `

.eco_wrch2
    sta l00f6                                                         ; adc2: 85 f6       ..
    txa                                                               ; adc4: 8a          .
    pha                                                               ; adc5: 48          H
    tya                                                               ; adc6: 98          .
    pha                                                               ; adc7: 48          H
    lda #&c2                                                          ; adc8: a9 c2       ..
    sta l00ee                                                         ; adca: 85 ee       ..
    jsr sub_cad3e                                                     ; adcc: 20 3e ad     >.
    pla                                                               ; adcf: 68          h
    tay                                                               ; add0: a8          .
    pla                                                               ; add1: 68          h
    tax                                                               ; add2: aa          .
    lda l00f6                                                         ; add3: a5 f6       ..
    jmp kern_nvwrch                                                   ; add5: 4c 55 fe    LU.

.cmd_NOTIFY
    ldx #&da                                                          ; add8: a2 da       ..
    jsr sub_ca873                                                     ; adda: 20 73 a8     s.
...
.cade2
    ...
    ldx #0                                                            ; ade5: a2 00       ..
.loop_cade7
    lda l0100,y                                                       ; ade7: b9 00 01    ...
    sta l0100,x                                                       ; adea: 9d 00 01    ...
    inx                                                               ; aded: e8          .
    iny                                                               ; adee: c8          .
    cmp #&0d                                                          ; adef: c9 0d       ..
...
.loop_cadf7
    ...
    sta l00d0,x                                                       ; adfa: 95 d0       ..
    dex                                                               ; adfc: ca          .
    bpl loop_cadf7                                                    ; adfd: 10 f8       ..
    lda l00da                                                         ; adff: a5 da       ..
    sta l00d2                                                         ; ae01: 85 d2       ..
    lda l00db                                                         ; ae03: a5 db       ..
    sta l00d3                                                         ; ae05: 85 d3       ..
    lda #&20                                                          ; ae07: a9 20       .
    ldy #&14                                                          ; ae09: a0 14       ..
    jsr ca818                                                         ; ae0b: 20 18 a8     ..
...
.cae1b
    ldx #0                                                            ; ae1b: a2 00       ..
    stx l00d9                                                         ; ae1d: 86 d9       ..
    inx                                                               ; ae1f: e8          .
    stx l00d8                                                         ; ae20: 86 d8       ..
    ldx #3                                                            ; ae22: a2 03       ..
.loop_cae24
    lda init_00d4_00d8_alt2,x                                         ; ae24: bd 39 af    .9.
    sta l00d4,x                                                       ; ae27: 95 d4       ..
    dex                                                               ; ae29: ca          .
    bpl loop_cae24                                                    ; ae2a: 10 f8       ..
    lda #&85                                                          ; ae2c: a9 85       ..
    sta l00d0                                                         ; ae2e: 85 d0       ..
    lda #&20                                                          ; ae30: a9 20       .
    ldy #&14                                                          ; ae32: a0 14       ..
    jsr ca818                                                         ; ae34: 20 18 a8     ..
    ldx #4                                                            ; ae37: a2 04       ..
.loop_cae39
    lda init_00d4_00d8_alt2,x                                         ; ae39: bd 39 af    .9.
    sta l00d4,x                                                       ; ae3c: 95 d4       ..
    dex                                                               ; ae3e: ca          .
    bpl loop_cae39                                                    ; ae3f: 10 f8       ..
    lda #&7f                                                          ; ae41: a9 7f       ..
    sta l00d0                                                         ; ae43: 85 d0       ..
    jsr ca85d                                                         ; ae45: 20 5d a8     ].
.loop_cae48
    jsr sub_ca799                                                     ; ae48: 20 99 a7     ..
    beq cae8e                                                         ; ae4b: f0 41       .A
    lda l00d0                                                         ; ae4d: a5 d0       ..
    bpl loop_cae48                                                    ; ae4f: 10 f7       ..
    jsr ca690                                                         ; ae51: 20 90 a6     ..
    lda #0                                                            ; ae54: a9 00       ..
    sta l00d4                                                         ; ae56: 85 d4       ..
    lda #1                                                            ; ae58: a9 01       ..
    sta l00d5                                                         ; ae5a: 85 d5       ..
    pla                                                               ; ae5c: 68          h
...
.cae62
    ...
    clc                                                               ; ae64: 18          .
    adc l00d4                                                         ; ae65: 65 d4       e.
    sta l00d6                                                         ; ae67: 85 d6       ..
    lda #0                                                            ; ae69: a9 00       ..
    adc l00d5                                                         ; ae6b: 65 d5       e.
    sta l00d7                                                         ; ae6d: 85 d7       ..
    lda #&80                                                          ; ae6f: a9 80       ..
    sta l00d0                                                         ; ae71: 85 d0       ..
    lda #&ff                                                          ; ae73: a9 ff       ..
    ldy #2                                                            ; ae75: a0 02       ..
    jsr ca818                                                         ; ae77: 20 18 a8     ..
    pla                                                               ; ae7a: 68          h
    clc                                                               ; ae7b: 18          .
    ...
    pha                                                               ; ae82: 48          H
    lda l00d6                                                         ; ae83: a5 d6       ..
    sta l00d4                                                         ; ae85: 85 d4       ..
    lda l00d7                                                         ; ae87: a5 d7       ..
    sta l00d5                                                         ; ae89: 85 d5       ..
    jmp cae62                                                         ; ae8b: 4c 62 ae    Lb.

.cae8e
    jsr ca690                                                         ; ae8e: 20 90 a6     ..
    pla                                                               ; ae91: 68          h
.cae92
    rts                                                               ; ae92: 60          `
...
.loop_caea9
    ...
    sta l00d0,x                                                       ; aeac: 95 d0       ..
    dex                                                               ; aeae: ca          .
    bpl loop_caea9                                                    ; aeaf: 10 f8       ..
    pla                                                               ; aeb1: 68          h
    sta l00d2                                                         ; aeb2: 85 d2       ..
    lda l0229                                                         ; aeb4: ad 29 02    .).
    sta l00d3                                                         ; aeb7: 85 d3       ..
    lda #<handler4                                                    ; aeb9: a9 27       .'
    sta l022a                                                         ; aebb: 8d 2a 02    .*.
    lda #>handler4                                                    ; aebe: a9 af       ..
    sta l022b                                                         ; aec0: 8d 2b 02    .+.
    lda #5                                                            ; aec3: a9 05       ..
    sta l00da                                                         ; aec5: 85 da       ..
    lda #&10                                                          ; aec7: a9 10       ..
    ldy #&32                                                          ; aec9: a0 32       .2
    jsr ca818                                                         ; aecb: 20 18 a8     ..
    ldx #4                                                            ; aece: a2 04       ..
.loop_caed0
    lda init_00d4_00d9,x                                              ; aed0: bd ec a6    ...
    sta l00d4,x                                                       ; aed3: 95 d4       ..
    dex                                                               ; aed5: ca          .
    bpl loop_caed0                                                    ; aed6: 10 f8       ..
    jsr oscrlf                                                        ; aed8: 20 ed ff     ..
    lda l00d2                                                         ; aedb: a5 d2       ..
    ldx #&2f                                                          ; aedd: a2 2f       ./
    sec                                                               ; aedf: 38          8
.loop_caee0
    sbc #&64                                                          ; aee0: e9 64       .d
...
.caf53
    ror l00fe                                                         ; af53: 66 fe       f.
    lda #5                                                            ; af55: a9 05       ..
    sta l0236                                                         ; af57: 8d 36 02    .6.
    lda #0                                                            ; af5a: a9 00       ..
...
.caf61
    ...
    ldx l0236                                                         ; af6c: ae 36 02    .6.
    sta l00ca,x                                                       ; af6f: 95 ca       ..
    inx                                                               ; af71: e8          .
    stx l0236                                                         ; af72: 8e 36 02    .6.
    cmp #3                                                            ; af75: c9 03       ..
...
.caf83
    ldx #&0f                                                          ; af83: a2 0f       ..
.loop_caf85
    lda l00d0,x                                                       ; af85: b5 d0       ..
    pha                                                               ; af87: 48          H
    dex                                                               ; af88: ca          .
    bpl loop_caf85                                                    ; af89: 10 fa       ..
    lda l022e                                                         ; af8b: ad 2e 02    ...
    sta l00d2                                                         ; af8e: 85 d2       ..
    lda l022f                                                         ; af90: ad 2f 02    ./.
    sta l00d3                                                         ; af93: 85 d3       ..
    lda #&d1                                                          ; af95: a9 d1       ..
    sta l00d1                                                         ; af97: 85 d1       ..
    lda l022a                                                         ; af99: ad 2a 02    .*.
    sta l0110                                                         ; af9c: 8d 10 01    ...
    lda l022b                                                         ; af9f: ad 2b 02    .+.
    sta l0111                                                         ; afa2: 8d 11 01    ...
    lda #<handler1                                                    ; afa5: a9 d0       ..
    sta l022a                                                         ; afa7: 8d 2a 02    .*.
    lda #>handler1                                                    ; afaa: a9 a6       ..
    sta l022b                                                         ; afac: 8d 2b 02    .+.
    lda #&ca                                                          ; afaf: a9 ca       ..
    sta l00d4                                                         ; afb1: 85 d4       ..
    lda #0                                                            ; afb3: a9 00       ..
    sta l00d5                                                         ; afb5: 85 d5       ..
    lda l0227                                                         ; afb7: ad 27 02    .'.
    eor #1                                                            ; afba: 49 01       I.
    sta l0227                                                         ; afbc: 8d 27 02    .'.
    and #1                                                            ; afbf: 29 01       ).
    bcs cafc5                                                         ; afc1: b0 02       ..
    ora #4                                                            ; afc3: 09 04       ..
.cafc5
    pha                                                               ; afc5: 48          H
    ldx l0236                                                         ; afc6: ae 36 02    .6.
    ldy #2                                                            ; afc9: a0 02       ..
    jsr sub_ca973                                                     ; afcb: 20 73 a9     s.
    jsr sub_caff1                                                     ; afce: 20 f1 af     ..
    lda #0                                                            ; afd1: a9 00       ..
    sta l0236                                                         ; afd3: 8d 36 02    .6.
    tax                                                               ; afd6: aa          .
    pla                                                               ; afd7: 68          h
    tay                                                               ; afd8: a8          .
.loop_cafd9
    pla                                                               ; afd9: 68          h
    sta l00d0,x                                                       ; afda: 95 d0       ..
    inx                                                               ; afdc: e8          .
    cpx #&10                                                          ; afdd: e0 10       ..
...
.pydis_end
    ...
    assert <(jump1_81_88-1) == &ba
    assert <(jump1_82-1) == &f6
    assert <(jump1_83_84_85-1) == &18
    assert <(jump1_86_87-1) == &34
    assert <(jump2_81-1) == &93
    assert <(jump2_82-1) == &ac
    assert <(jump2_83-1) == &d5
    assert <(jump2_84-1) == &c0
    assert <(jump2_85-1) == &c9
    assert <(jump2_86-1) == &13
    assert <(jump2_87-1) == &2f
    assert <(jump2_88-1) == &82
    ...
    assert >(jump1_81_88-1) == &a4
    assert >(jump1_82-1) == &a4
    assert >(jump1_83_84_85-1) == &a5
    assert >(jump1_86_87-1) == &a5
    assert >(jump2_81-1) == &a5
    assert >(jump2_82-1) == &a5
    assert >(jump2_83-1) == &a5
    assert >(jump2_84-1) == &a5
    assert >(jump2_85-1) == &a5
    assert >(jump2_86-1) == &a6
    assert >(jump2_87-1) == &a6
    assert >(jump2_88-1) == &a5
    ...
    assert eco_rdch2 == &ad9e
    assert eco_save == &a9bb
    assert eco_shut == &abe5
    assert eco_star == &aba3
    assert eco_wrch == &af48
    assert eco_wrch2 == &adc2
    assert jump3_00-1 == &a99e
    assert jump3_01-1 == &aa71
    assert jump3_02-1 == &ac11
    assert jump3_03-1 == &ac89
    assert jump3_04_05-1 == &a939
    assert jump3_06-1 == &acbe
    assert jump3_07-1 == &acb1
    assert jump3_08-1 == &acc5
